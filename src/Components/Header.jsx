        ...
        <div id="skills">
          ...
          <div className="skills-list">
            <div className="skill-item">
              <img src="./src/assets/Logo_Images/html_logo.png" alt="HTML5 Logo" />
              <p>HTML5</p>
            </div>

            <div className="skill-item">
              <img src="./src/assets/Logo_Images/css_logo.png" alt="CSS3 Logo" />
              <p>CSS3</p>
            </div>

            <div className="skill-item">
              <img src="./src/assets/Logo_Images/JavaScript_logo.png" alt="JavaScript Logo" />
              <p>JavaScript</p>
            </div>

            <div className="skill-item">
              <img src="./src/assets/Logo_Images/react.svg" alt="React Logo" />
              <p>React</p>
            </div>
          </div>
        </div>
